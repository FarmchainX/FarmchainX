...
public class FarmerNotificationsController {

    private final FarmerHelperService helperService;
    private final JdbcTemplate jdbcTemplate;

    @GetMapping
    public ResponseEntity<List<Map<String, Object>>> getNotifications(Authentication authentication) {
        helperService.getFarmerByEmail(authentication.getName());
